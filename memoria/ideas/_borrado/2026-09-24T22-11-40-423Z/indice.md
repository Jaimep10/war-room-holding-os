# Índice de Ideas — Portafolio de Negocios

| ID | Nombre corto | Archivo | Estado | Última actualización |
|----|--------------|---------|--------|-----------------------|
| IDEA-1 | quiero hacer un equipo de marketing especializado en odontologia para ecuador usando un eq | `IDEA-1-quiero-hacer-un-equipo-de.md` | Filtro 1 - Viabilidad | 2026-09-23 |
| IDEA-2 | estrellitas day care | `IDEA-2-estrellitas-day-care.md` | Filtro 1 - Viabilidad | 2026-09-23 |
